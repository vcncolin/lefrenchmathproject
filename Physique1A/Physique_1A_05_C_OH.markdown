...
*(On verra dans la suite du cours comment retrouver cette solution)*
...
(En général pour un problème physique, on aura deux racines négatives pour un problème amorti. Sinon la solution tend vers l'infini...)
